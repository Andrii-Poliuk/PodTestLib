...
Pod::Spec.new do |s|
  s.name             = 'PodsTestLib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PodsTestLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/PodsTestLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Admin' => 'andrii.polyuk@blackthorn-vision.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/PodsTestLib.git', :tag => s.version.to_s }
